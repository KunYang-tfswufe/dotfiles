User-1:
``````text
请教我云(我是云初学者,我没有钱也没有信用卡去启动免费的云套餐,但是朋友告诉我可以用aws-cli和localstack,我用的哥哥的电脑他自己装的debian,我主要学习的编程语言是java),我希望类似codecademy那样的极小微代码项目每个小节,(一开始讲解然后是作业,对于作业请给我每一步要做什么风格就像codecademy一样,它的作业风格类似一个作业拆分成多个检查点每个检查点都有明确的指令指向去引导我完成,每个小节完成了我把作业给你检查,你不要一小节太多东西,我的水平很差可能接受不了,我们开始第一个小节, 什么时候毕业你下定论
``````
Model-1:
``````markdown
