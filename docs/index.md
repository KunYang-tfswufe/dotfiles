...
- [ ] 把ssh当作vpn尝试使用
- [ ] 直接用word写论文或文章是错误的
我想学习直接操作物理内存地址用c(我是编程初学者,因为我对内存实在没有概念而且我想看懂代码中的操作0xxx,我了解到有一种叫做单片机的东西是可以直接操作物理内存地址的而不是逻辑地址的,但是我没有实体但是我了解到可以通过模拟网站),我希望类似codecademy那样的极小微代码项目每个小节,(一开始讲解然后是作业,对于作业请给我每一步要做什么风格就像codecademy一样,它的作业风格类似一个作业拆分成多个检查点每个检查点都有明确的指令指向去引导我完成,每个小节完成了我把作业给你检查)你不要一小节太多东西,我的水平很差可能接受不了,我们开始第一个小节, 什么时候毕业你下定论
