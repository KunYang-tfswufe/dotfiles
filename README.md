...
```bash
sudo pacman -Syu --needed cockpit openssh waybar grim slurp wl-clipboard fcitx5-im fcitx5-rime ntfs-3g zellij jq zoxide ripgrep bat 7zip flatpak bottom wireshark-cli github-cli mpv obs-studio yt-dlp rustscan dust okular tigervnc docker docker-compose fish qemu-full edk2-ovmf ollama-cuda rpi-imager npm rclone swaybg minicom starship stow playerctl dunst sof-firmware veracrypt ffmpeg cronie sshfs gawk avahi arp-scan android-tools scrcpy yazi eza
```
