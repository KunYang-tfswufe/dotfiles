...
```bash
sudo pacman -Syu --needed cockpit openssh grim slurp wl-clipboard fcitx5-im fcitx5-rime zellij jq zoxide 7zip flatpak wireshark-cli rustscan dust docker docker-compose qemu-full edk2-ovmf ollama-cuda npm swaybg minicom starship stow playerctl dunst veracrypt ffmpeg cronie sshfs gawk avahi arp-scan eza
```
